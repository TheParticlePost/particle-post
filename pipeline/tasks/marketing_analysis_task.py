...
def build_marketing_analysis_task(agent: Agent) -> Task:
    ...
    return Task(
        description=(
            ...
            "3.  search_console('top_queries')    — top Google search queries\n"
            "4.  search_console('opportunities')  — ranking 5-20, 50+ impressions: quick-win targets\n"
            "5.  search_console('top_pages')      — top Google clicked pages\n"
            "6.  bing_query_stats                 — top Bing/Edge search queries (last 30 days)\n"
            "7.  bing_page_stats                  — top Bing/Edge pages by clicks\n"
            "8.  bing_crawl_stats                 — Bing indexing health\n"
            "9.  google_trends                    — trending AI/finance topics right now\n"
            "10. tavily_search('AI finance blog content strategy 2026') — competitor intel\n\n"

            "If any tool returns an error or '[Not configured]', note it and continue.\n\n"
            ...
            "   - BING vs GOOGLE GAP: Are there keywords performing well on Bing but not Google "
            "     (or vice versa)? Cross-engine gaps reveal content authority issues.\n"
            "   - Bing crawl errors: are any pages not being indexed by Bing?\n"
