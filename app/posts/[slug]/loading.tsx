export default function PostLoading() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 animate-pulse">
      ...
      {/* Title */}
      <div className="h-10 bg-bg-tertiary rounded-lg mb-3 w-full" />
      <div className="h-10 bg-bg-tertiary rounded-lg mb-6 w-3/4" />
      ...
      {/* Cover image */}
      <div className="aspect-[2/1] bg-bg-tertiary rounded-2xl mb-10" />
