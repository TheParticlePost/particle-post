...
{{< stat-box value="$400,000" label="Combined SEC penalties against Delphia and Global Predictions for false AI marketing claims" source="U.S. Securities and Exchange Commission, March 2024" >}}
...
For a deeper look at how governance frameworks protect companies from AI-related regulatory exposure, read the full analysis on [AI Agent Governance Framework: 5-Step Control Plan](/posts/ai-agent-governance-framework-5-steps/). For the banking-specific compliance picture under the EU AI Act, see [EU AI Act Enforcement: AI Compliance Banking Guide](/posts/eu-ai-act-enforcement-banking-compliance/).

## Frequently Asked Questions

### Q: What is AI washing and why is it a legal risk in 2026?
AI washing means making unsubstantiated claims about a product's AI capabilities in marketing, investor, or sales materials. The FTC, SEC, and EU regulators now treat these claims as potential consumer deception, securities fraud, or both. The DoNotPay settlement and the SEC's 2024 actions against Delphia and Global Predictions confirm active enforcement.
...
Yes. Companies that repeat a vendor's unsubstantiated AI claims in their own investor or customer materials take on shared liability, according to FTC guidance on endorsements and testimonials. Contracts with performance warranties and independent verification reduce but do not eliminate that risk.

### Q: What penalties does the EU AI Act impose for misleading AI claims?
The EU AI Act imposes fines up to 3 percent of global annual revenue for non-compliant AI claims in regulated sectors, according to the European Commission's published penalty schedule. For a company with $500 million in revenue, that equals $15 million per violation.

### Q: How many FTC investigations into AI marketing claims have been opened?
The FTC opened more than 50 investigations into AI-related marketing claims between 2022 and 2025, according to agency public records. The agency's 2023 "AI Claims" policy guidance identified specific trigger phrases, including "AI-powered" and "machine learning-driven," as requiring documented substantiation.
