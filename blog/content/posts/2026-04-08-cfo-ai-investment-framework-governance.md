...
{{< stat-box value="74%" label="Share of enterprise AI pilots that never produce a documented ROI case" source="Gartner" >}}
...
For a deeper look at how enterprise AI ROI frameworks separate high-performing deployments from expensive experiments, read the full research breakdown on [enterprise AI ROI practices that unlock 55% returns](/posts/enterprise-ai-roi-practices). To understand how agentic AI systems are changing the speed of these decisions, see the analysis on [agentic AI finance readiness](/posts/agentic-ai-finance-readiness).

{{< stat-box value="2.4x" label="Higher likelihood of above-expected AI returns at firms with formal investment governance" source="McKinsey" >}}
...
A CFO AI investment framework is a set of financial criteria, vendor selection standards, and ROI measurement requirements finance leaders establish before AI pilots begin. It defines success metrics, spend thresholds, contract terms, and audit requirements. Without one, technology and operations teams make vendor and architecture decisions that finance inherits without having shaped.

### Q: When should a CFO get involved in AI strategy?
A CFO should get involved in AI strategy before any vendor contracts are signed or pilots begin. McKinsey's 2025 AI adoption survey found companies with formal governance frameworks in place from the start were 2.4 times more likely to report above-expected AI returns. Waiting until pilots conclude leaves finance auditing decisions it had no hand in making.

### Q: Why do so many enterprise AI pilots fail to show ROI?
Gartner reports 74% of enterprise AI pilots never produce a documented ROI case. The core reason is that baseline metrics, target outcomes, and measurement timelines are not defined before pilots launch. Finance's absence from early-stage planning means no one builds the accountability structure that makes ROI measurement possible.

### Q: What is the minimum spend threshold for requiring an AI ROI contract?
A threshold of $50,000 in combined license, implementation, and internal labor costs is a practical starting point. Any AI initiative at or above that level should require a pre-pilot ROI contract with a baseline metric, target metric, measurement timeline, and a kill clause before work begins.

### Q: How does agentic AI change CFO governance requirements?
Agentic AI systems that act autonomously across procurement, invoicing, and operations workflows accelerate vendor lock-in faster than traditional software. CFOs must define data portability rights and audit trail requirements before agentic tools are deployed, because autonomous systems embed into core processes within weeks, not months.
