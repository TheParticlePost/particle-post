        ...
        >
          ...
          <div className="py-1">
            <Link
              ...
              role="menuitem"
              onClick={close}
              className="flex items-center gap-2 px-3 py-2 text-body-sm text-foreground hover:bg-bg-tertiary/50 transition-colors"
            >
            ...
            <>
              ...
              <div className="py-1">
                <Link
                  ...
                  role="menuitem"
                  onClick={close}
                  className="flex items-center gap-2 px-3 py-2 text-body-sm text-accent hover:bg-bg-tertiary/50 transition-colors"
                >
          ...
          <div className="py-1">
            <button
              ...
              className="flex items-center gap-2 w-full px-3 py-2 text-body-sm text-foreground-secondary hover:text-foreground hover:bg-bg-tertiary/50 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
